...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, M1_DIR_Pin|GPIO_IR_LED2_Pin|GPIO_IR_LED1_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = ADC_IR_LD_Pin|ADC_IR_LS_Pin|ADC_IR_RS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : PAPin PAPin PAPin */
  GPIO_InitStruct.Pin = M1_DIR_Pin|GPIO_IR_LED2_Pin|GPIO_IR_LED1_Pin;
